...
class FormatRequestBaseBody(unittest.TestCase):
    ...
    def test__dict_data_template(self):
        expected = {"tagName": "1", "description": "hello", "createdAt": "2008-10-10", "compareUrl": "http://"}
...
def test_file_type_constant():
    actual = {"markdown": ".md", "json": ".json", "rest": ".rst"}
